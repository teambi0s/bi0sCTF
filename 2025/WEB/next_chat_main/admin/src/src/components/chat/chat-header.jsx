...
import { Info, MenuIcon, MessageSquareWarning, CheckCircle, AlertTriangle, XCircle } from "lucide-react";
...
export default function ChatHeader({ 
  ...
  const handleReport = async () => {
    ...
    try {
      ...
      if (result.abusive) {
        toast.success("The chat was found to be abusive; actions will be taken.", {
