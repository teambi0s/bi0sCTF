  ...
  return (
    <div className="w-16 border-r flex flex-col items-center justify-between bg-background shadow-sm py-4">
      <div className="flex flex-col items-center space-y-4">
        <div className="w-10 h-10 rounded-full flex items-center justify-center text-primary-foreground font-bold text-lg mb-6">
          <img src="/logo.png" alt="Next Chat logo" />          
        </div>
      </div>
